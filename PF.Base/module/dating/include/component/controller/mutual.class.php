 ...
 */
class Dating_Component_Controller_Mutual extends Phpfox_Component
{
	/**
	 * Controller
	 */
	public function process()
	{
        ...
        //HIDE NOTIFICATIOIN
        Dating_Service_Dating::instance()->hideMutual();

        $this->template()->setTitle(_p('Dating'));
        $this->template()->setBreadCrumb(_p('Dating'), $this->url()->makeUrl("dating"));
        $this->template()->setBreadCrumb(_p("Mutual Likes"), $this->url()->makeUrl("dating.mutual"));
        ...
        $this->search()->set(array(
                ...
                'search_tool' => array(
                    'table_alias' => 'f',
                    'search' => array(
                        'action' => $this->url()->makeUrl('dating.mutual'),
        ...
        $this->search()->setCondition(" AND f.mutual=1 AND f.owner_id=".Phpfox::getUserId());
