 ...
 */
class Dating_Component_Controller_Mylike extends Phpfox_Component
{
	/**
	 * Controller
	 */
	public function process()
	{
        ...
        $this->template()->setBreadCrumb(_p("I like"), $this->url()->makeUrl("dating.mylike"));
        ...
        $this->search()->set(array(
                ...
                'search_tool' => array(
                    'table_alias' => 'f',
                    'search' => array(
                        'action' => $this->url()->makeUrl('dating.mylike'),
        ...
        $this->search()->setCondition(" AND f.is_own=1 AND f.mutual=0 AND f.owner_id=".Phpfox::getUserId());
